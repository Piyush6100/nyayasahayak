        ...
        <div className="flex items-center justify-between px-4 pb-3 relative">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              disabled={disabled}
              className={`p-2 rounded-lg transition-colors disabled:opacity-40 relative ${
                attachments.length > 0 ? 'bg-primary/10 text-primary font-semibold' : 'text-muted-foreground hover:text-foreground hover:bg-muted'
              }`}
                  ...
                  {supportedLangs.map((lang) => (
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 text-[13px] flex items-center justify-between transition-colors ${
                        selectedLang.code === lang.code ? 'text-primary font-semibold bg-primary/5' : 'text-foreground hover:bg-muted'
                      }`}
                    >
