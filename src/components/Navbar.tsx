                ...
                >
                  {languages?.map((lang) => (
                    <button
                      ...
                      className={`w-full text-left px-4 py-2 text-[13px] transition-colors duration-100 ${selectedLang?.code === lang?.code
            ...
            <div className="pt-2 border-t border-border mt-2">
              {languages?.map((lang) => (
                <button
                  ...
                  className={`block w-full text-left px-4 py-2.5 rounded-xl text-[14px] transition-colors ${selectedLang?.code === lang?.code ? 'text-primary font-medium' : 'text-muted-foreground hover:bg-muted'
                    }`}
                >
                  {lang?.label}
                </button>
